...
const PeparHeader = ({ headerDetails, questionsList }) => {
  const Header = {
    ...
    board: "Gujarat Board",
    subject: "English",
    logo: "https://backend.nexuspublication.com/storage/logos/Im2lsiupGNHFGc49j8ZtlMYH6H08BoNl39W7bx6S.jpg",
    questions: null,
  };

  return (
    console.log("headerDetails.logo", headerDetails.logo),
    (
      <View>
        <View
          style={tw(
        ...
        >
          ...
          <View style={tw("w-full text-center")}>
            <Text style={tw("text-[25px] leading-5 font-serif font-bold mb-1")}>
        ...
        <View style={tw("flex flex-row justify-between items-center w-full")}>
          ...
          <View>
            ...
            <Text style={tw("text-sm font-serif font-bold")}>
              DATE : {dayjs(headerDetails?.date).format("DD-MM-YYYY") || "N/A"}
            </Text>
          </View>
          <View>
            <Text style={tw("text-sm font-serif font-bold")}>
