        ...
        <div className="flex flex-col items-center md:flex-row md:justify-between gap-3 lg:gap-2">
          <div className="bg-white p-6 rounded-lg shadow-lg max-w-xs md:max-w-sm mb-4 md:mb-0  h-64 overflow-scroll">
            ...
            <p className="text-gray-600">
              You can Download Books, Solutions, Question papers with solutions
              and study material in PDF format and help the students. Behind the
              screens of this educational titan is a team of dedicated
              professionals and educators. Their passion and expertise shine
              through in every lesson, tutorial, and resource, ensuring that
              students receive the best study material.
            </p>
          </div>
          <div className="bg-white p-6 h-64 rounded-lg shadow-lg max-w-xs md:max-w-sm mb-4 md:mb-0 overflow-scroll">
            ...
            <p className="text-gray-600">
              Our goal is to provide exceptional value and service to our
              students, ensuring their success and satisfaction by delivering
              high-quality study material and solutions.
            </p>
          </div>
          <div className="bg-white p-6 h-64 rounded-lg shadow-lg max-w-xs md:max-w-sm overflow-scroll">
            ...
            <p className="text-gray-600">
              Our mission is to leverage our expertise and technology to solve
              complex challenges and paper generator is one such example. You
              can generate question paper automatically by simply selecting
        ...
        <div className="text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            <div className="bg-white p-6 rounded-lg shadow-lg">
              <h3 className="text-xl font-semibold mb-2">Nursery</h3>
